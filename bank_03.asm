...
#_038119: JSL QueueUpVRAMTransfers_long
...
#_0385DB: LDA.w $19CE
#_0385DE: CMP.w #$001A ; STATE 1A
#_0385E1: BEQ .exit

#_0385E3: CMP.w #$0028 ; STATE 28
#_0385E6: BEQ .exit

#_0385E8: CMP.w #$002A ; STATE 2A
#_0385EB: BEQ .exit
...
#_038755: LDA.l pointers04FC8B,X
#_038759: TAX
...
#_038780: LDA.l pointers04FCD1,X
#_038784: TAX
...
#_038BC3: JSL QueueUpVRAMTransfers_long
...
SpawnSprite00A2_AtMyCoordinates:
#_03916D: PHB
#_03916E: PHK
#_03916F: PLB
...
#_0394E4: JMP AddToScore_x10_Variable
...
#_039511: JSR AddToScore_x10_Variable
...
#_03961F: JSL FindNextExtraLifeMilestone_long
...
; Add an extra life at certain milestones
#_039645: JSL FindNextExtraLifeMilestone_long
...
#_039AEB: LDA.w #$0148 ; PARTNER 0148
#_039AEE: STA.w $05CE
...
#_039DF3: LDA.w #$00E8 ; PARTNER 00E8
#_039DF6: STA.w $05CE
...
#_039E27: LDA.w $05CE
#_039E2A: CMP.w #$001E ; PARTNER 001E
#_039E2D: BEQ CODE_039E61

#_039E2F: LDY.w #$000E
#_039E32: CMP.w #$00FE ; PARTNER 00FE
#_039E35: BEQ CODE_039E61

#_039E37: LDY.w #$0008
#_039E3A: CMP.w #$007E ; PARTNER 007E
#_039E3D: BEQ CODE_039E61

#_039E3F: LDY.w #$0006
#_039E42: CMP.w #$005E ; PARTNER 005E
#_039E45: BEQ CODE_039E61

#_039E47: LDY.w #$000A
#_039E4A: CMP.w #$009E ; PARTNER 009E
#_039E4D: BEQ CODE_039E61

#_039E4F: LDY.w #$0004
#_039E52: CMP.w #$003E ; PARTNER 003E
#_039E55: BEQ CODE_039E61

#_039E57: LDY.w #$000C
#_039E5A: CMP.w #$00BE ; PARTNER 00BE
...
#_039E8B: dw $FFD0, $FFD0, $0060, $0060
#_039E93: dw $FFC0, $FFC0, $0080, $0080
#_039E9B: dw $FFB0, $FFB0, $00A0, $00A0
#_039EA3: dw $FFA0, $FFA0, $00C0, $00C0
#_039EAB: dw $FF90, $FF90, $00E0, $00E0
#_039EB3: dw $FF80, $FF80, $0100, $0100
#_039EBB: dw $FF40, $FF40, $0180, $0180
#_039EC3: dw $FF10, $FF10, $01E0, $01E0
#_039ECB: dw $FEE0, $FEE0, $0240, $0240
#_039ED3: dw $0000, $0000, $0000, $0000
#_039EDB: dw $FE80, $FE00, $0300, $0200
#_039EE3: dw $FE00, $FC80, $0400, $0380
#_039EEB: dw $FFC0, $FFC0, $0080, $0200
#_039EF3: dw $FFF0, $FF00, $0020, $0200
#_039EFB: dw $FE80, $FE00, $0300, $0480
#_039F03: dw $FF00, $FE00, $0200, $0200
#_039F0B: dw $FE00, $FD00, $0400, $0400
#_039F13: dw $FF00, $FF00, $0200, $0100
#_039F1B: dw $FE80, $FE00, $0300, $0300
#_039F23: dw $FF80, $FE80, $0100, $0380
#_039F2B: dw $FF00, $FD80, $0200, $0500
#_039F33: dw $FF80, $FD00, $0100, $0380
#_039F3B: dw $FF00, $FC80, $0200, $0500
#_039F43: dw $FE00, $FF80, $0400, $0100
#_039F4B: dw $FD80, $FF00, $0500, $0200
#_039F53: dw $FA80, $FA00, $0200, $0200
#_039F5B: dw $0380, $FA00, $0200, $0200
#_039F63: dw $FB80, $FE00, $0180, $0300
#_039F6B: dw $0300, $FE00, $0180, $0300
#_039F73: dw $FE00, $FF80, $0400, $0200
#_039F7B: dw $FC00, $FA00, $0180, $0600
#_039F83: dw $0280, $FA00, $0180, $0600
#_039F8B: dw $FA80, $FA80, $0300, $0300
#_039F93: dw $0280, $FA80, $0300, $0300
#_039F9B: dw $FA00, $FA00, $0400, $0200
#_039FA3: dw $0200, $FA00, $0400, $0200
#_039FAB: dw $FB80, $FA80, $0200, $0580
#_039FB3: dw $0280, $FA80, $0200, $0580
#_039FBB: dw $FC80, $FA00, $0200, $0500
#_039FC3: dw $0180, $FA00, $0200, $0500
#_039FCB: dw $FD80, $FC00, $0500, $0500
#_039FD3: dw $FF20, $0000, $01C0, $0200
#_039FDB: dw $FD80, $0000, $0500, $0100
#_039FE3: dw $FE00, $FD00, $0400, $0400
#_039FEB: dw $FE80, $FE00, $0300, $0200
#_039FF3: dw $FD80, $FF80, $0300, $0200
#_039FFB: dw $FC00, $0000, $0200, $0080
#_03A003: dw $FE00, $0000, $0200, $0080
#_03A00B: dw $FE80, $FE80, $0300, $0300
...
#_03A35B: dw SpriteAI_0002                                           ; 0x0002
#_03A35D: dw SpriteAI_0004                                           ; 0x0004
#_03A35F: dw SpriteAI_0006                                           ; 0x0006
#_03A361: dw Sprite_PartnerSwapInit                                  ; 0x0008
#_03A363: dw SpriteAI_000A                                           ; 0x000A
#_03A365: dw SpriteAI_000C                                           ; 0x000C
#_03A367: dw SpriteAI_000E                                           ; 0x000E
...
#_03A377: dw SpriteAI_001E                                           ; 0x001E
#_03A379: dw SpriteAI_0020                                           ; 0x0020
#_03A37B: dw SpriteAI_0022                                           ; 0x0022
#_03A37D: dw SpriteAI_0024                                           ; 0x0024
#_03A37F: dw SpriteAI_0026                                           ; 0x0026
#_03A381: dw SpriteAI_0028                                           ; 0x0028
#_03A383: dw SpriteAI_002A                                           ; 0x002A
#_03A385: dw SpriteAI_002C                                           ; 0x002C
#_03A387: dw SpriteAI_002E                                           ; 0x002E
#_03A389: dw SpriteAI_0030                                           ; 0x0030
#_03A38B: dw SpriteAI_0032                                           ; 0x0032
#_03A38D: dw SpriteAI_0034                                           ; 0x0034
#_03A38F: dw SpriteAI_0036                                           ; 0x0036
#_03A391: dw SpriteAI_0038                                           ; 0x0038
#_03A393: dw SpriteAI_003A                                           ; 0x003A
#_03A395: dw SpriteAI_001E                                           ; 0x003C
#_03A397: dw SpriteAI_003E                                           ; 0x003E
#_03A399: dw SpriteAI_0040                                           ; 0x0040
#_03A39B: dw SpriteAI_0042                                           ; 0x0042
#_03A39D: dw SpriteAI_0044                                           ; 0x0044
#_03A39F: dw SpriteAI_0046                                           ; 0x0046
#_03A3A1: dw SpriteAI_0048                                           ; 0x0048
#_03A3A3: dw SpriteAI_004A                                           ; 0x004A
#_03A3A5: dw SpriteAI_004C                                           ; 0x004C
...
#_03A7FE: LDA.w data03A82B+0,Y
#_03A801: STA.w $081A,X

#_03A804: LDA.w data03A82B+2,Y
...
data03A82B:
#_03A82B: dw $0000, $0021
#_03A82F: dw $0000, $001F
#_03A833: dw $000C, $001F
#_03A837: dw $000C, $0021
#_03A83B: dw $0011, $001F
#_03A83F: dw $0006, $0020
#_03A843: dw $000C, $0024
#_03A847: dw $000C, $0022

data03A84B:
#_03A84B: dw $0006, $FFFC
#_03A84F: dw $FFF9, $FFFE
#_03A853: dw $0002, $0007
#_03A857: dw $0004, $FFFA
#_03A85B: dw $FFF9, $0000
#_03A85F: dw $0004, $0006
#_03A863: dw $0002, $FFF9
#_03A867: dw $FFF9, $0002
...
#_03A9A7: LDA.w data03A84B+0,Y
#_03A9AA: STA.w $081A,X

#_03A9AD: LDA.w data03A84B+2,Y
...
#_03BA71: LDA.w #$0040 ; SFX 40
#_03BA74: BRA .set_sfx

CODE_03BA76:
#_03BA76: LDA.w #$0042 ; SFX 42
...
#_03BE8B: LDA.w $19CE
#_03BE8E: ADC.w #$0028 ; STATE 2A (minus 2)
#_03BE91: STA.w $19CE
...
data03C1E8:
#_03C1E8: dw data05E74E, data05E75E
#_03C1EC: dw data05E72E, data05E73E
#_03C1F0: dw data05E76E, data05E75E
#_03C1F4: dw data05E7D6, data05E7E6
#_03C1F8: dw data05E77E, data05E78E
#_03C1FC: dw data05E79E, data05E75E
#_03C200: dw data05E7F6, data05E806
#_03C204: dw data05E7F6, data05E806
#_03C208: dw data05E74E, data05E75E
...
data03C3C5:
#_03C3C5: dw $0001, $0024
#_03C3C9: dw $0003, $002A
#_03C3CD: dw $FFFF
...
#_03C432: JSL QueueUpVRAMTransfers_long
...
#_03C44E: JSL QueueUpVRAMTransfers_long
...
data03C454:
#_03C454: dw $6200, $8180, $EC00
#_03C45A: dw $6200, $8180, $F000
#_03C460: dw $6200, $81C0, $F400
#_03C466: dw $6200, $81C0, $F800
#_03C46C: dw $6200, $81C0, $FC00
#_03C472: dw $6420, $8100, $E400
#_03C478: dw $6200, $8140, $E800
#_03C47E: dw $6200, $8140, $E8C0
#_03C484: dw $6080, $8040, $9100
#_03C48A: dw $6080, $8040, $9140
#_03C490: dw $6080, $8080, $9180
#_03C496: dw $6080, $8080, $9400
#_03C49C: dw $6080, $8080, $9480
#_03C4A2: dw $6080, $8080, $9500
#_03C4A8: dw $6080, $8080, $9580
#_03C4AE: dw $6080, $8080, $9800

;---------------------------------------------------------------------------------------------------

data03C4B4:
#_03C4B4: dw $0001, $0000
#_03C4B8: dw $0003, $0006
#_03C4BC: dw $0005, $0000
#_03C4C0: dw $0007, $0006
#_03C4C4: dw $0009, $0000
#_03C4C8: dw $000B, $0006
#_03C4CC: dw $000D, $000C
#_03C4D0: dw $000F, $0012
#_03C4D4: dw $0011, $0018
#_03C4D8: dw $0013, $001E
#_03C4DC: dw $FFFF, $FFFF
...
data03C531:
#_03C531: dw $0001, $0030
#_03C535: dw $0003, $0036
#_03C539: dw $0005, $003C
#_03C53D: dw $0007, $0042
#_03C541: dw $0009, $0048
#_03C545: dw $000B, $0042
#_03C549: dw $000D, $0048
#_03C54D: dw $000F, $0042
#_03C551: dw $0011, $0048
#_03C555: dw $0013, $0042
#_03C559: dw $0015, $004E
#_03C55D: dw $0017, $0054
#_03C561: dw $0019, $005A
#_03C565: dw $FFFF, $FFFF
...
#_03CC63: JSL SpawnSprite00A2_AtMyCoordinates
...
#_03D111: JSL SpawnSprite00A2_AtMyCoordinates
...
#_03D341: BEQ .continue

#_03D343: STZ.b $20
#_03D345: STZ.b $22

#_03D347: JSR ROUTINE_038B73
#_03D34A: BCC .continue
...
#_03D571: JSL SpawnSprite00A2_AtMyCoordinates
...
#_03D6A2: CMP.w #$000C
#_03D6A5: BCS .continue

#_03D6A7: LDA.b $00
#_03D6A9: ROR A
#_03D6AA: BCS .continue
...
data03D78A:
#_03D78A: dw $FFF0, $FFF0
#_03D78E: dw $0010, $FFF0
#_03D792: dw $FFF0, $0010
#_03D796: dw $0010, $0010
...
#_03D7F1: CMP.w #$000C
#_03D7F4: BCS .continue

#_03D7F6: LDA.b $00
#_03D7F8: ROR A
#_03D7F9: BCS .continue
...
#_03D919: JSL SpawnSprite00A2_AtMyCoordinates
...
#_03D968: LDA.w $05CE
#_03D96B: CMP.w #$0046 ; PARTNER 0046
#_03D96E: BEQ CODE_03D9AE

#_03D970: CMP.w #$004E ; PARTNER 004E
#_03D973: BEQ CODE_03D9AE

#_03D975: CMP.w #$00A6 ; PARTNER 00A6
#_03D978: BEQ CODE_03D9AE

#_03D97A: CMP.w #$00AE ; PARTNER 00AE
...
#_03DD42: LDA.w $05CE
#_03DD45: CMP.w #$0106 ; PARTNER 0106
...
CODE_03DDE8:
#_03DDE8: LDA.w $05CE
#_03DDEB: CMP.w #$010C ; PARTNER 010C
#_03DDEE: BEQ CODE_03DE3C

#_03DDF0: CMP.w #$0112 ; PARTNER 0112
#_03DDF3: BEQ CODE_03DE30

#_03DDF5: CMP.w #$010E ; PARTNER 010E
...
#_03E104: LDA.w #$011A ; PARTNER 011A
#_03E107: STA.w $05CE

CODE_03E10A:
#_03E10A: LDA.w $05CE
#_03E10D: CMP.w #$0116 ; PARTNER 0116
#_03E110: BEQ CODE_03E158

#_03E112: CMP.w #$0118 ; PARTNER 0118
#_03E115: BEQ CODE_03E144

#_03E117: CMP.w #$011A ; PARTNER 011A
...
#_03E3C2: LDA.w $05CE
#_03E3C5: CMP.w #$0130 ; PARTNER 0130
...
#ROUTINE_03E40A:
#_03E40A: CMP.w #$012A ; PARTNER 012A
#_03E40D: BCC .exit
...
ROUTINE_03E422:
#_03E422: CMP.w #$0130 ; PARTNER 0130
...
CODE_03E490:
#_03E490: LDA.w $05CE
#_03E493: CMP.w #$0136 ; PARTNER 0136
#_03E496: BNE .exit_b
...
#_03E4C0: LDA.w data03E4E4+0,Y
#_03E4C3: STA.w $081E,X

#_03E4C6: LDA.w data03E4E4+2,Y
...
#_03E4E8: dw $0380, $AD00
#_03E4EC: dw $0180, $AD00
#_03E4F0: dw $0080, $AD00
...
#_03E612: JSR Set_7E7A08_to_000D
...
#_03E7D0: JSL QueueUpVRAMTransfers_long
...
#_03F48F: dw $FF30, $0000
#_03F493: dw $FF60, $FFB0
#_03F497: dw $0020, $FF50
...
data03FF44:
#_03FF44: dw $FFFC, $0004, $0000
#_03FF4A: dw $0000, $0004, $0002
#_03FF50: dw $0002, $0002, $0004
#_03FF56: dw $FFFF
