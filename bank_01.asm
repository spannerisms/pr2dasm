...
#_018318: dw ROUTINE_01867B                                   ; B0
#_01831A: dw ROUTINE_01867B                                   ; B2
#_01831C: dw ROUTINE_018601                                   ; B4
#_01831E: dw ROUTINE_01861A                                   ; B6
#_018320: dw Pocky_CutsceneControl                            ; B8
#_018322: dw Pocky_ReturnFromMagic                            ; BA
#_018324: dw ROUTINE_018330                                   ; BC
#_018326: dw ROUTINE_01834A                                   ; BE
#_018328: dw ROUTINE_018364                                   ; C0
#_01832A: dw ROUTINE_0191AD                                   ; C2
#_01832C: dw ROUTINE_019243                                   ; C4
#_01832E: dw ROUTINE_01935F                                   ; C6
...
#_0188EE: LDA.w #data01890B
#_0188F1: LDY.w #data01890B>>16
...
#_018954: LDA.w #data018965
#_018957: LDY.w #data018965>>16
#_01895A: JSL ROUTINE_00FBCB_ParameterizedBounce_long
...
#_018CA8: JSL QueueUpTilemapTransfers_long
#_018CAC: CLC
...
#_018CB9: JSL QueueUpTilemapTransfers_long
#_018CBD: RTS
...
CODE_019184:
#_019184: JMP ROUTINE_0191A4

;===================================================================================================

Pocky_PartnerToss_Robed:
#_019187: LDA.w $194C
#_01918A: BEQ ROUTINE_0191A4
...
ROUTINE_019231:
#_019231: LDX.w #$000E
#_019234: JSR ROUTINE_01ACA7_preserve_X
...
#_019338: JSR ROUTINE_019342_Set19CE_to002A
...
ROUTINE_019342_Set19CE_to002A:
#_01933C: LDA.w #$002A  ; STATE 2A

;===================================================================================================

ROUTINE_019342_Set19CE:
#_01933F: STA.w $19CE
...
#_01AB02: JSL QueueUpTilemapTransfers_long
...
#_01AB13: JSL QueueUpTilemapTransfers_long
#_01AB17: RTS
...
#_01ABC1: JSL QueueUpTilemapTransfers_long
...
ROUTINE_01ACA7_preserve_X_long:
#_01AC8D: PHB
#_01AC8E: PHK
#_01AC8F: PLB

#_01AC90: JSR ROUTINE_01ACA7_preserve_X
...
data01AD95:
#_01AD95: db $1D, $16, $00, $80, $7F, $00, $62, $00
#_01AD9D: db $00

;---------------------------------------------------------------------------------------------------

data01AD9E:
#_01AD9E: db $1D, $0E, $00, $80, $7F, $00, $62, $00
#_01ADA6: db $00

;---------------------------------------------------------------------------------------------------

data01ADA7:
#_01ADA7: db $1D, $06, $00, $80, $7F, $00, $62, $00
#_01ADAF: db $00

;---------------------------------------------------------------------------------------------------

data01ADB0:
#_01ADB0: db $1D, $1B, $00, $80, $7F, $00, $62, $00
#_01ADB8: db $00

;---------------------------------------------------------------------------------------------------

data01ADB9:
#_01ADB9: db $1D, $21, $00, $80, $7F, $00, $62, $00
#_01ADC1: db $00

;---------------------------------------------------------------------------------------------------

data01ADC2:
#_01ADC2: db $1D, $0F, $00, $80, $7F, $00, $62, $00
#_01ADCA: db $00
...
#_01AE03: JSL QueueUpTilemapTransfers_long
...
#_01AE14: JSL QueueUpTilemapTransfers_long
...
#_01AE5B: JSL QueueUpTilemapTransfers_long
...
#_01AE6C: JSL QueueUpTilemapTransfers_long
#_01AE70: JSR ROUTINE_01AAAA

#_01AE73: LDA.w #$C580
#_01AE76: JMP ROUTINE_01AED6
...
#_01AEE7: JSL QueueUpTilemapTransfers_long
...
#_01AEF8: JSL QueueUpTilemapTransfers_long
#_01AEFC: RTS
...
#_01AF75: dw LittleNinja_0016                                         ; 0x0016
#_01AF77: dw LittleNinja_0018                                         ; 0x0018
...
#_01AFB7: dw BomberBob_D19F                                           ; 0x0058
...
#_01AFD7: dw Scarecrow_CD04                                           ; 0x0078
...
#_01B017: dw Ottobot_C3A2                                             ; 0x00B8
...
#_01B057: dw Rocky_BC87                                               ; 0x00F8
#_01B059: dw Rocky_BD8D                                               ; 0x00FA
...
#_01B06D: dw ROUTINE_01B766_bounce                                    ; 0x010E
...
#_01B0C4: LDX.w ROUTINE_01BE28,Y ; TODO ????
...
#_01B1ED: LDA.w data01B214+0,X
#_01B1F0: STA.w $05D8

#_01B1F3: LDA.w data01B214+2,X
#_01B1F6: STA.w $05DA
...
CODE_01BC91:
#_01BC91: JSR ROUTINE_01A67F_021C
...
CODE_01BD9F:
#_01BD9F: JSR ROUTINE_01A67F_021C
...
#_01C261: JSL QueueUpTilemapTransfers_long
...
#_01C272: JSL QueueUpTilemapTransfers_long
...
#_01C2A8: JSL QueueUpTilemapTransfers_long
...
#_01C2B9: JSL QueueUpTilemapTransfers_long
...
CODE_01C3B5:
#_01C3B5: JSR ROUTINE_01A67F_021C
...
CODE_01C8CF:
#_01C8CF: JSR ROUTINE_01A67F_021C
...
#_01CFA7: LDA.w data01CFB5+2,Y
#_01CFAA: AND.w #$00FF
#_01CFAD: STA.b $3E

#_01CFAF: LDA.w data01CFB5+0,Y
...
CODE_01D01F:
#_01D01F: JSR ROUTINE_01A67F_021C
...
CODE_01D0C8:
#_01D0C8: JSR ROUTINE_01A67F_021C
...
CODE_01D1AC:
#_01D1AC: JSR ROUTINE_01A67F_021C
...
#_01D5EE: JSL QueueUpTilemapTransfers_long
...
#_01D5FF: JSL QueueUpTilemapTransfers_long
...
CODE_01D768:
#_01D768: JSR ROUTINE_01A67F_021C
...
CODE_01DD8C:
#_01DD8C: JSR ROUTINE_01A67F_021C
...
LittleNinja_0018:
#_01DE9C: JSR ROUTINE_01A67F_021C
...
ROUTINE_01DF0F:
#_01DF0F: PHA
#_01DF10: JSR ROUTINE_019342_Set19CE_to002A
...
#_01DF34: JSR ROUTINE_019342_Set19CE
...
#_01DF50: JSR ROUTINE_019342_Set19CE
...
#_01E139: JSL QueueUpTilemapTransfers_long
...
#_01E14A: JSL QueueUpTilemapTransfers_long
